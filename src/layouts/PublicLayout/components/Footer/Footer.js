      ...
      <footer class="bg-gray-900 text-gray-600 body-font">
        <div class="container px-5 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
              ...
              <span style={{ fontFamily: 'Luckiest Guy' }} class="ml-3 text-xl tracking-wider"><span style={{ fontFamily: 'Luckiest Guy' }} className="text-pink-400 tracking-wider">Cakes</span>And<span style={{ fontFamily: 'Luckiest Guy' }} className="tracking-wider text-yellow-400">Cards</span></span>
            </a>
            <p class="mt-2 text-sm text-gray-500">Air plant banjo lyft occupy retro adaptogen indego</p>
          </div>
          <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            <div class="lg:w-1/4 md:w-1/2 w-full px-4">
              <h2 class="title-font font-bold text-gray-200 tracking-widest text-sm mb-3">Links</h2>
        ...
        <div class="bg-gray-100">
          <div class="container px-5 py-3 mx-auto flex items-center sm:flex-row flex-col">
            ...
            <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2021 CakesAndCard —
