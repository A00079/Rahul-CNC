            ...
            <section class="text-gray-600 body-font relative">
                <div class="container px-5 mt-24 mx-auto">
                    <div class="flex flex-col text-center w-full">
                        <h2 style={{ fontFamily: 'Luckiest Guy' }} class="tracking-widest text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Contact Us</h2>
                        <h1 style={{ fontFamily: 'Luckiest Guy' }} class="tracking-widest sm:text-3xl text-4xl font-medium title-font mb-4 text-indigo-700">Get In Touch With Us</h1>
