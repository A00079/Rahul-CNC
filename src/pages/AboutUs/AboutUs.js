                            ...
                            <main class="mt-20 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                                <div class="sm:text-center lg:text-left">
                                    <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-5xl">
                                        <span style={{ fontFamily: 'Luckiest Guy' }} class="inline sm:block xl:inline tracking-wider">Know More</span><br />
                                        <span style={{ fontFamily: 'Luckiest Guy' }} class="inline sm:block  text-indigo-600 xl:inline tracking-wider">About Us</span>
                                    </h1>
